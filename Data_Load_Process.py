...
def load_data(contact_matrix_path_train, contact_matrix_path_test, mapping_train_path, scale_factor, IF_alpha):
    x_train = []
    y_train = []
    x_test = []
    y_test = []
    ...
    return_shape = (x_train.shape[1], 1)
    ...
    return x_train, y_train, x_test, y_test, return_shape, scales_cal_values, matrix_table_test
